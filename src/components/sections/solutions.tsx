                ...
                <div className="grid grid-cols-1 gap-6 md:grid-cols-3 lg:gap-8">
                    {services.map((service) => (
                        <div
                            key={service.title}
                            className={cn(
                                "group relative overflow-hidden rounded-2xl border border-sanwa-border bg-white/5 p-8 transition-all hover:bg-white/10 hover:shadow-2xl hover:border-sanwa-border/50",
                                service.className
                            )}
                        >
